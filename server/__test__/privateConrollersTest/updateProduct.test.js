...
import { updateProduct } from '../../controllers/privateControllers.js';
...
describe('Update Profile Controller', () => {
  ...
  beforeAll(() => {
    ...
    updatedData = {
      ...
      averageRating: 0,
      ratingCount: 0,
      imageUrl: '1718694858213portfolio pic.jpg',
      publicId: '1718694858213portfolio pic.jpg',
      weight: 2,
      dimensions: '10x5x2',
      isActive: true,
      userId: '66705e325a40560fa8f3a358',
  ...
  it('Should return 200 status code when the Profile Pic is updated', async () => {
    ...
    await uploadImage.mockImplementation(
      () => '1718694858213portfolio pic.jpg'
    );
  ...
  it('Should return 404 status code when Product Not Found the Profile Pic is updated', async () => {
    ...
    await expect(updateProduct(mockRequest, mockResponse)).rejects.toThrow(
      NotFoundError
    );
    await expect(updateProduct(mockRequest, mockResponse)).rejects.toThrowError(
      'Product Not Found'
    );
  });
